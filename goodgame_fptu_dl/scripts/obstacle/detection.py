...
class DepthProcessor:
    ...
    def remove_ground(self, gray_img, column, row, n_row, lower, upper):
        ...
        """
        #rospy.logerr("Value: " + str(gray_img[row][column]))
    ...
    def detect_obstacle(self, img_np, n_row=2, lower=80, upper=10, min_width=20, min_height=20):
        """
        Detect obstacle
